...
callback = function(req, res) {
  ...
  if (state === null || state !== storedState) {
    res.redirect('https://66d6770da7edd4935a70d865--clever-salmiakki-41791b.netlify.app?' +
      querystring.stringify({
    ...
    request.post(authOptions, async function(error, response, body) {
      if (!error && response.statusCode === 200) { 
        ...
        try {
          ...
          res.redirect('https://66d6770da7edd4935a70d865--clever-salmiakki-41791b.netlify.app/profile');
        } catch (error) {
